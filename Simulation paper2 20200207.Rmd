...
4) Iterate through steps 1, 2, and 3 (or more if more than three strata are considered) until the weighted sample characteristics match the population characteristics. 
...
*Research question 4*: What is the role of response rate, form, and the distribution of underlying population attitudes in the *effectiveness* of weighting? **[perhaps David can derive/find a proof to parallel our results?]** (Table 1 + ResponseRate1 + SDForm2 + Figure 4)
