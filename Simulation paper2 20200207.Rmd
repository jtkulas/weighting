...
*Research question 1a*: What role does overall response *rate* play in sample misrepresentation? **[make sure this is reflected in results]**

A couple paragraphs to answer RQ1

Have to operationalie "sample misrepresentation" first
...
```{r Figure1, echo=FALSE, fig.cap="Relationship between total response rate and misrepresentation.",fig.height=4.5, fig.width=6.5}
