...
\caption{\label{fig:example1}Terminology and interplay of simulated population elements referred to throughout the current exploration.}
\end{figure}
