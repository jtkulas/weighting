...
\emph{Research question 1}: What role does response rate play in population misrepresentation? \(\blacksquare\)\footnote{11/7/24 -- Effect is moderated -- there is not a simple relationship between response rate and misrepresentation. Rather, a wide range of representative/error-filled estimates can be expected all along the response rate continuum. See Figure \ref{fig:ResponseRate1}}

\emph{Research question 2}: What role does nonresponse form (passive versus active) play in population misrepresentation? \(\square\)\footnote{Figure \ref{fig:SDForm2} shows that the largest misrepresentation sampling scenarios are associated with \emph{greater degrees of} active nonresponse. However, there also exist active nonresponse scenarios within which little or no misrepresentation occurs.}
...
It has been stated that active nonresponse is relatively harmless unless the actively nonrespondent group is relatively large\^{}{[}\textbf{NEED TO CHECK CITES FOR RELEVANCE}It should also be pointed out that although the active nonrespondent group seems to be a great concern, it will not seriously bias the results unless the proportion of active nonrespondents is higher than 15\% (Rogelberg et al., 2003; Rogelberg \& Stanton, 2007; Werner et al., 2007).
``In this study we found that the active nonrespondent group was relatively small (approximately 15\%), but consistent in size with research conducted by .'' (Rogelberg et al., 2003, pp. 1110--1111). ``Furthermore, consistent with Roth (1994) who stated that when missingness is not random (as we found for active nonrespondents), meaningful bias will only be introduced if the group is relatively large (which was not the case in this study).'' (Rogelberg et al., 2003, p. 1112). ``If the results show that the active nonrespondent group comprises a low proportion of the population, fewer concerns for bias arise. If the proportion of active respondents is greater than 15\% of the group of individuals included in the interviews or focus groups (this has been the average rate in other studies), generalizability may be compromised.'' (Rogelberg \& Stanton, 2007, p. 201) * I believe there is an error here. The author want to say that if the proportion of active nonrespondents is greater than 15\% of the group .

``It has been suggested that it takes a response rate of 85\% to conclude that nonresponse error is not a threat (Dooely \& Lindner, 2003). We agree that researchers should provide both empirical and theoretical evidence refuting nonresponse bias whenever the response rate is less than 85\%.'' (Werner et al., 2007, p. 293).{]}. The current study, however, suggests that post-data-collection remediation. There may also be some important implications here regarding sample (and population) size. Because organizational surveyors likely interface with organizations of varying sizes (perhaps some of which are small- or medium-sized), the implications of our simulations particularly in the small population conditions, were highlighted. Findings specific to these conditions were: XXX, XXX, XXX.
...
Although the weighted mean proved an unbiased estimate of the population mean across all simulations, in circumstances where no bias existed in the unweighted estimate, the trade-off between bias-correction and random error of precision (e.g., standard error) also needs to be acknowledged.
...
\bibitem[\citeproctext]{ref-anseel_response_2010}
...
\bibitem[\citeproctext]{ref-biemer_introduction_2003}
Biemer, P. P., \& Lyberg, L. E. (2003). \emph{Introduction to survey quality} (Vol. 335). John Wiley \& Sons.

\bibitem[\citeproctext]{ref-bobko_usefulness_2007}
...
\bibitem[\citeproctext]{ref-cook_meta-analysis_2000}
...
\bibitem[\citeproctext]{ref-curtin_effects_2000}
...
\bibitem[\citeproctext]{ref-cycyota_enhancing_2002}
...
\bibitem[\citeproctext]{ref-cycyota_what_2006}
...
\bibitem[\citeproctext]{ref-deming_least_1940}
...
\bibitem[\citeproctext]{ref-fulton_organizations_2016}
...
\bibitem[\citeproctext]{ref-heitjan_distinguishing_1996}
...
\bibitem[\citeproctext]{ref-holtom2022survey}
...
\bibitem[\citeproctext]{ref-keeter_gauging_2006}
...
\bibitem[\citeproctext]{ref-kessler_national_2009}
...
\bibitem[\citeproctext]{ref-krosnick_survey_1999}
Krosnick, J. A. (1999). Survey research. \emph{Annual Review of Psychology}, \emph{50}(1), 537--567.

\bibitem[\citeproctext]{ref-kulas_nonresponse_2017}
...
\bibitem[\citeproctext]{ref-kulas_post-stratification_2016}
...
\bibitem[\citeproctext]{ref-landers_inconvenient_2015}
...
\bibitem[\citeproctext]{ref-luong_how_1998}
...
\bibitem[\citeproctext]{ref-muthen_structural_1987}
...
\bibitem[\citeproctext]{ref-quine_feeling_2008}
...
\bibitem[\citeproctext]{ref-rivers_inference_2009}
...
\bibitem[\citeproctext]{ref-rogelberg_profiling_2003}
...
\bibitem[\citeproctext]{ref-rogelberg_employee_2000}
...
\bibitem[\citeproctext]{ref-rogelberg_introduction_2007}
...
\bibitem[\citeproctext]{ref-spitzmuller_survey_2007}
...
\bibitem[\citeproctext]{ref-taris_how_2007}
...
\bibitem[\citeproctext]{ref-tett_2011_2014}
...
\bibitem[\citeproctext]{ref-visser_mail_1996}
...
\bibitem[\citeproctext]{ref-wainer_estimating_1976}
