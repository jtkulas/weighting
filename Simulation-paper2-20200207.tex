...
\item
  correct the .51 estimate in the Cattell section
\item
  find the figure with ``red'' and ``grey'' standard error bars (standard error section)
\end{enumerate}
