...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-latex/example1-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-latex/ResponseRate1-1.pdf}}
\caption{\label{fig:ResponseRate1}Relationship between total response rate and misrepresentation.}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-latex/SDForm2-1.pdf}}
\caption{\label{fig:SDForm2}Relationship between nonresponse form and misrepresentation.}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-latex/Cattell3-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-latex/Overall4-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-latex/CattelExplain-1.pdf}}
